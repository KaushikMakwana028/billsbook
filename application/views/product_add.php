<div class="page-wrapper">
    <div class="page-content">
        <style>
            ...
            .product-preview-box.is-visible {
                display: flex;
            }
                ...
                <div class="card rounded-4 product-form-card">
                    <div class="card-body p-4 p-xl-5">
                        <div class="mb-4">
                            ...
                            <p class="product-form-copy mb-0">Create a new product for the current admin. Product images are stored in `uploads/product`.</p>
                        </div>
                        ...
                        <form method="post" action="<?= base_url('product/store') ?>" enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 product-field">
                                    ...
                                    <label for="product_image_add" class="product-file-trigger w-100">
                                        <span class="product-file-button">Choose File</span>
                                        <span class="product-file-name" id="product_file_name_add">No file chosen</span>
                                    </label>
                                </div>
                                <div class="col-12">
                                    <div class="product-preview-box" id="product_preview_box_add">
                                        <img src="" id="product_preview_add" class="product-preview-image" alt="Selected product image">
                                        <div>
                                            <div class="fw-semibold text-dark">Selected image preview</div>
                                            <small class="text-muted">Choose an image and it will appear here before saving.</small>
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var previewBox = document.getElementById('product_preview_box_add');
        var fileName = document.getElementById('product_file_name_add');

        if (!input || !preview || !previewBox || !fileName) {
            return;
        }
